...
import com.neelraj.soundcloudstreamer.soundcloud.SoundCloud;
import com.neelraj.soundcloudstreamer.soundcloud.SoundCloudService;
...
public class MainActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                mPlayerStateButton.setImageResource(R.drawable.ic_play_arrow_24dp);
            }
        });
    ...
    private void toggleSongState() {
        if(mMediaPlayer.isPlaying()) {
            ...
            mMediaPlayer.start();
            mPlayerStateButton.setImageResource(R.drawable.ic_pause_24dp);
        }
    }
